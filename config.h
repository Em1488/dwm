...
//static const char col_cyan[]        = "#2e3841";
...
static const char *herbevol[] = { "/home/em/.local/bin/herbevol", NULL };
...
//	{ MODKEY,                       XK_f,      setlayout,      {.v = &layouts[1]} },
	...
	{ MODKEY,                       XK_a,      setgaps,        {.i = GAP_RESET } },
	{ MODKEY|ControlMask,           XK_a,      setgaps,        {.i = GAP_TOGGLE} },
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
	...
	{ MODKEY|ShiftMask,             XK_Escape,      quit,           {0} },
        ...
        { 0,    XF86XK_AudioMute,                  spawn,          {.v = herbevol} },
        { 0,    XF86XK_AudioLowerVolume,           spawn,          {.v = voldown} },
        { 0,    XF86XK_AudioLowerVolume,           spawn,          {.v = herbevol} },
        { 0,    XF86XK_AudioRaiseVolume,           spawn,          {.v = volup} },
        { 0,    XF86XK_AudioRaiseVolume,           spawn,          {.v = herbevol} },

        { MODKEY|ShiftMask,             XK_w,      spawn,          {.v = browser} },
        { MODKEY|ShiftMask,             XK_e,      spawn,          SPAWN("nemo") },
        { MODKEY,                       XK_Print,  spawn,          SPAWN("screenshot") },
        { 0,    XF86XK_TouchpadToggle,             spawn,          SPAWN("touchpad_toggle.sh") },
};
